...
2. Проаналізувати, в які дні тижня та години найбільше продажів.
...
Створив колонку **transaction_timestamp**, для підрахунку унікальної кількості транзакцій та виведення середньої кількості проданих одиниць за одну транзакцію (за допомогою формули =SUM(transaction_qty)/COUNTUNIQUE(transaction_timestamp))
...
**product_type** - підкатегорія (29 значень).
...
3. Використовуйте вбудований фільтр на дашборді для аналізу даних окремо по кожному закладу.
